...
public class VetGorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vet_gor);
    ...
    View.OnClickListener onClickListener_call = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:0415578575"));
