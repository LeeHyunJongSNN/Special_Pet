...
public class VetPikasoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vet_pikaso);
    ...
    View.OnClickListener onClickListener_call = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:0234276419"));
