...
public class VetSeoulhqActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vet_seoulhq);
    ...
    View.OnClickListener onClickListener_call = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:028888807"));
